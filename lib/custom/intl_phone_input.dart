...
class _InputWidgetState extends State<CustomInternationalPhoneNumberInput> {
  ...
  String? validator(String? value) {
    bool isValid = this.isNotValid &&
        ((value?.isNotEmpty ?? false) || widget.ignoreBlank == false);
...
class CustomSelectorButton extends StatelessWidget {
  ...
  Future<Country?> showCountrySelectorBottomSheet(
    ...
    return showModalBottomSheet(
      ...
      isScrollControlled: isScrollControlled,  // إذا كانت قيمة isScrollControlled غير null دائماً
